	...
	<view class="all">
		<view class="u-input">
			...
			<view class="button-hover">
				<button type="primary" size="default" @click="shipBasicInformationAdd1" plain="true">添加</button>
			</view>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			async shipBasicInformationAdd1(){
				const {code,success,message,data} = await shipBasicInformationAdd(this.form)
				if(success===true){
					uni.showToast({
						title: '修改成功',
						icon: 'success',
